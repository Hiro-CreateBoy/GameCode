...
public class PlayerRei : MonoBehaviour
{
    ...
    [Header("ジャンプの高さ")] public float jumpHight;//ジャンプの高さ
    [Header("ジャンプの速度")] public float jumpSpeed;//ジャンプの速度
    [Header("ジャンプ制限時間")] public float jumpLimitTime;//ジャンプ制限時間
    [Header("踏みつけ判定の高さの割合")] public float stepOnRate;//踏みつけ判定の高さの割合
    [Header("接地判定")] public GroundCheck ground;//接地判定
    [Header("頭をぶつけた判定")] public GroundCheck head;//頭をぶつけた判定
    [Header("ダッシュの速さ表現")] public AnimationCurve dashCurve;
    [Header("ジャンプの速さ表現")] public AnimationCurve jumpCurve;
    [Header("ジャンプするときに鳴らす")] public AudioClip jumpSE;//ジャンプするときに鳴らす
